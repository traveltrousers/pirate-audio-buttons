...
if __name__ == '__main__':
	def do_short():
		os.system ('mpc vol +10')

	def do_long():
		os.system ('mpc random off')
		os.system ('mpc repeat off')
		os.system ('mpdrandom -c -l')

pin = 24
short_duration = 0.7
long_duration = 1.5

btn = cmdbutton(pin=pin,short_duration=short_duration,long_duration=long_duration,short_action = do_short,long_action=do_long)
